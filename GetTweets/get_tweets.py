...
# function that creates the movie hashtag for each movie
...
# function that returns the movie release dates
def get_dates(f):
    dates = list()
...
# function that yields the last date out of all the movies
def get_last_date(f):
    tweets = f.readlines()
    i = -1
...
# function that writes the tweets to an output file 
